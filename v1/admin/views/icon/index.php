...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/public/admin/lib/layui/css/layui.css">
	<link rel="stylesheet" type="text/css" href="/public/admin/lib/layui/css/icon.css">
	<style type="text/css">
    /* 宫格 */
...
<div class="layui-fluid">
    ...
    <div class="layui-card-header" style="text-align: center;font-size:25px;" id="layui">layui图标库列表</div>
      <div class="layui-card-body">
        <ul class="site-doc-icon">
          <li><i class="layui-icon layui-icon-duihua"></i><div class="name">对话</div><div class="code">layui-icon-duihua</div></li>
          <li><i class="layui-icon layui-icon-shezhi"></i><div class="name">设置</div><div class="code">layui-icon-shezhi</div></li>
          <li><i class="layui-icon layui-icon-yinshenim"></i><div class="name">隐身im</div><div class="code">layui-icon-yinshenim</div></li>
          <li><i class="layui-icon layui-icon-search"></i><div class="name">搜索</div><div class="code">layui-icon-search</div></li>
          <li><i class="layui-icon layui-icon-fenxiang1"></i><div class="name">分享</div><div class="code">layui-icon-fenxiang1</div></li>
          <li><i class="layui-icon layui-icon-shezhi1"></i><div class="name">设置1</div><div class="code">layui-icon-shezhi1</div></li>
          <li><i class="layui-icon layui-icon-yinqing"></i><div class="name">引擎</div><div class="code">layui-icon-yinqing</div></li>
          <li><i class="layui-icon layui-icon-close"></i><div class="name">关闭</div><div class="code">layui-icon-close</div></li>
          <li><i class="layui-icon layui-icon-close-fill"></i><div class="name">关闭-fill</div><div class="code">layui-icon-close-fill</div></li>
          <li><i class="layui-icon layui-icon-baobiao"></i><div class="name">报表</div><div class="code">layui-icon-baobiao</div></li>
          <li><i class="layui-icon layui-icon-star"></i><div class="name">星星</div><div class="code">layui-icon-star</div></li>
          <li><i class="layui-icon layui-icon-yuandian"></i><div class="name">圆点</div><div class="code">layui-icon-yuandian</div></li>
          <li><i class="layui-icon layui-icon-chat"></i><div class="name">聊天</div><div class="code">layui-icon-chat</div></li>
          <li><i class="layui-icon layui-icon-logo"></i><div class="name">logo</div><div class="code">layui-icon-logo</div></li>
          <li><i class="layui-icon layui-icon-list"></i><div class="name">列表</div><div class="code">layui-icon-list</div></li>
          <li><i class="layui-icon layui-icon-tubiao"></i><div class="name">图表</div><div class="code">layui-icon-tubiao</div></li>
          <li><i class="layui-icon layui-icon-ok-circle"></i><div class="name">ok-圆圈</div><div class="code">layui-icon-ok-circle</div></li>
          <li><i class="layui-icon layui-icon-huanfu2"></i><div class="name">换肤</div><div class="code">layui-icon-huanfu2</div></li>
          <li><i class="layui-icon layui-icon-On-line"></i><div class="name">在线</div><div class="code">layui-icon-On-line</div></li>
          <li><i class="layui-icon layui-icon-biaoge"></i><div class="name">表格</div><div class="code">layui-icon-biaoge</div></li>
          <li><i class="layui-icon layui-icon-right"></i><div class="name">右箭头</div><div class="code">layui-icon-right</div></li>
          <li><i class="layui-icon layui-icon-left"></i><div class="name">左箭头</div><div class="code">layui-icon-left</div></li>
          <li><i class="layui-icon layui-icon-cart-simple"></i><div class="name">购物车</div><div class="code">layui-icon-cart-simple</div></li>
          <li><i class="layui-icon layui-icon-cry"></i><div class="name">哭</div><div class="code">layui-icon-cry</div></li>
          <li><i class="layui-icon layui-icon-smile"></i><div class="name">笑</div><div class="code">layui-icon-smile</div></li>
          <li><i class="layui-icon layui-icon-survey"></i><div class="name">调查</div><div class="code">layui-icon-survey</div></li>
          <li><i class="layui-icon layui-icon-tree"></i><div class="name">树</div><div class="code">layui-icon-tree</div></li>
          <li><i class="layui-icon layui-icon-iconfont17"></i><div class="name">上箭头-圆圈</div><div class="code">layui-icon-iconfont17</div></li>
          <li><i class="layui-icon layui-icon-tianjia"></i><div class="name">添加</div><div class="code">layui-icon-tianjia</div></li>
          <li><i class="layui-icon layui-icon-download-circle"></i><div class="name">下箭头-圆圈</div><div class="code">layui-icon-download-circle</div></li>
          <li><i class="layui-icon layui-icon-xuanzemoban48"></i><div class="name">选择模板</div><div class="code">layui-icon-xuanzemoban48</div></li>
          <li><i class="layui-icon layui-icon-gongju"></i><div class="name">工具</div><div class="code">layui-icon-gongju</div></li>
          <li><i class="layui-icon layui-icon-face-surprised"></i><div class="name">惊讶</div><div class="code">layui-icon-face-surprised</div></li>
          <li><i class="layui-icon layui-icon-bianji"></i><div class="name">编辑</div><div class="code">layui-icon-bianji</div></li>
          <li><i class="layui-icon layui-icon-speaker"></i><div class="name">喇叭</div><div class="code">layui-icon-speaker</div></li>
          <li><i class="layui-icon layui-icon-down"></i><div class="name">下箭头</div><div class="code">layui-icon-down</div></li>
          <li><i class="layui-icon layui-icon-wenjian"></i><div class="name">文件</div><div class="code">layui-icon-wenjian</div></li>
          <li><i class="layui-icon layui-icon-layouts"></i><div class="name">布局</div><div class="code">layui-icon-layouts</div></li>
          <li><i class="layui-icon layui-icon-duigou"></i><div class="name">√对勾</div><div class="code">layui-icon-duigou</div></li>
          <li><i class="layui-icon layui-icon-tianjia1"></i><div class="name">添加1</div><div class="code">layui-icon-tianjia1</div></li>
          <li><i class="layui-icon layui-icon-yaoyaozhibofanye"></i><div class="name">翻页</div><div class="code">layui-icon-yaoyaozhibofanye</div></li>
          <li><i class="layui-icon layui-icon-read"></i><div class="name">阅读</div><div class="code">layui-icon-read</div></li>
          <li><i class="layui-icon layui-icon-404"></i><div class="name">404</div><div class="code">layui-icon-404</div></li>
          <li><i class="layui-icon layui-icon-lunbozutu"></i><div class="name">轮播组图</div><div class="code">layui-icon-lunbozutu</div></li>
          <li><i class="layui-icon layui-icon-help"></i><div class="name">帮助</div><div class="code">layui-icon-help</div></li>
          <li><i class="layui-icon layui-icon-daima1"></i><div class="name">代码</div><div class="code">layui-icon-daima1</div></li>
          <li><i class="layui-icon layui-icon-jinshui"></i><div class="name">进水</div><div class="code">layui-icon-jinshui</div></li>
          <li><i class="layui-icon layui-icon-username"></i><div class="name">用户名</div><div class="code">layui-icon-username</div></li>
          <li><i class="layui-icon layui-icon-find-fill"></i><div class="name">搜索-fill</div><div class="code">layui-icon-find-fill</div></li>
          <li><i class="layui-icon layui-icon-about"></i><div class="name">关于</div><div class="code">layui-icon-about</div></li>
          <li><i class="layui-icon layui-icon-location"></i><div class="name">坐标</div><div class="code">layui-icon-location</div></li>
          <li><i class="layui-icon layui-icon-up"></i><div class="name">上箭头</div><div class="code">layui-icon-up</div></li>
          <li><i class="layui-icon layui-icon-pause"></i><div class="name">暂停</div><div class="code">layui-icon-pause</div></li>
          <li><i class="layui-icon layui-icon-riqi"></i><div class="name">日期</div><div class="code">layui-icon-riqi</div></li>
          <li><i class="layui-icon layui-icon-uploadfile"></i><div class="name">上传</div><div class="code">layui-icon-uploadfile</div></li>
          <li><i class="layui-icon layui-icon-delete"></i><div class="name">删除</div><div class="code">layui-icon-delete</div></li>
          <li><i class="layui-icon layui-icon-play"></i><div class="name">播放</div><div class="code">layui-icon-play</div></li>
          <li><i class="layui-icon layui-icon-top"></i><div class="name">返回顶部</div><div class="code">layui-icon-top</div></li>
          <li><i class="layui-icon layui-icon-haoyouqingqiu"></i><div class="name">好友请求</div><div class="code">layui-icon-haoyouqingqiu</div></li>
          <li><i class="layui-icon layui-icon-refresh-3"></i><div class="name">刷新</div><div class="code">layui-icon-refresh-3</div></li>
          <li><i class="layui-icon layui-icon-weibiaoti1"></i><div class="name">对号</div><div class="code">layui-icon-weibiaoti1</div></li>
          <li><i class="layui-icon layui-icon-chuangkou"></i><div class="name">窗口</div><div class="code">layui-icon-chuangkou</div></li>
          <li><i class="layui-icon layui-icon-comiisbiaoqing"></i><div class="name">表情</div><div class="code">layui-icon-comiisbiaoqing</div></li>
          <li><i class="layui-icon layui-icon-zhengque"></i><div class="name">正确</div><div class="code">layui-icon-zhengque</div></li>
          <li><i class="layui-icon layui-icon-dollar"></i><div class="name">美元</div><div class="code">layui-icon-dollar</div></li>
          <li><i class="layui-icon layui-icon-iconfontwodehaoyou"></i><div class="name">我的好友</div><div class="code">layui-icon-iconfontwodehaoyou</div></li>
          <li><i class="layui-icon layui-icon-wenjianxiazai"></i><div class="name">文件下载</div><div class="code">layui-icon-wenjianxiazai</div></li>
          <li><i class="layui-icon layui-icon-tupian"></i><div class="name">图片</div><div class="code">layui-icon-tupian</div></li>
          <li><i class="layui-icon layui-icon-lianjie"></i><div class="name">链接</div><div class="code">layui-icon-lianjie</div></li>
          <li><i class="layui-icon layui-icon-diamond"></i><div class="name">钻石</div><div class="code">layui-icon-diamond</div></li>
          <li><i class="layui-icon layui-icon-jilu"></i><div class="name">记录</div><div class="code">layui-icon-jilu</div></li>
          <li><i class="layui-icon layui-icon-liucheng"></i><div class="name">流程</div><div class="code">layui-icon-liucheng</div></li>
          <li><i class="layui-icon layui-icon-fontstrikethrough"></i><div class="name">删除线</div><div class="code">layui-icon-fontstrikethrough</div></li>
          <li><i class="layui-icon layui-icon-unlink"></i><div class="name">断开链接</div><div class="code">layui-icon-unlink</div></li>
          <li><i class="layui-icon layui-icon-bianjiwenzi"></i><div class="name">编辑文字</div><div class="code">layui-icon-bianjiwenzi</div></li>
          <li><i class="layui-icon layui-icon-sanjiao"></i><div class="name">三角</div><div class="code">layui-icon-sanjiao</div></li>
          <li><i class="layui-icon layui-icon-danxuankuanghouxuan"></i><div class="name">单选框候选</div><div class="code">layui-icon-danxuankuanghouxuan</div></li>
          <li><i class="layui-icon layui-icon-danxuankuangxuanzhong"></i><div class="name">单选框选中</div><div class="code">layui-icon-danxuankuangxuanzhong</div></li>
          <li><i class="layui-icon layui-icon-juzhongduiqi"></i><div class="name">居中对齐</div><div class="code">layui-icon-juzhongduiqi</div></li>
          <li><i class="layui-icon layui-icon-youduiqi"></i><div class="name">右对齐</div><div class="code">layui-icon-youduiqi</div></li>
          <li><i class="layui-icon layui-icon-zuoduiqi"></i><div class="name">左对齐</div><div class="code">layui-icon-zuoduiqi</div></li>
          <li><i class="layui-icon layui-icon-gongsisvgtubiaozongji22"></i><div class="name">复选框候选</div><div class="code">layui-icon-gongsisvgtubiaozongji22</div></li>
          <li><i class="layui-icon layui-icon-gongsisvgtubiaozongji23"></i><div class="name">复选框选中</div><div class="code">layui-icon-gongsisvgtubiaozongji23</div></li>
          <li><i class="layui-icon layui-icon-refresh-2"></i><div class="name">刷新-2</div><div class="code">layui-icon-refresh-2</div></li>
          <li><i class="layui-icon layui-icon-loading-1"></i><div class="name">加载1</div><div class="code">layui-icon-loading-1</div></li>
          <li><i class="layui-icon layui-icon-return"></i><div class="name">返回</div><div class="code">layui-icon-return</div></li>
          <li><i class="layui-icon layui-icon-jiacu"></i><div class="name">加粗</div><div class="code">layui-icon-jiacu</div></li>
          <li><i class="layui-icon layui-icon-uploading"></i><div class="name">上传中</div><div class="code">layui-icon-uploading</div></li>
          <li><i class="layui-icon layui-icon-liaotianduihuaimgoutong"></i><div class="name">聊天对话</div><div class="code">layui-icon-liaotianduihuaimgoutong</div></li>
          <li><i class="layui-icon layui-icon-video"></i><div class="name">视频</div><div class="code">layui-icon-video</div></li>
          <li><i class="layui-icon layui-icon-headset"></i><div class="name">耳机</div><div class="code">layui-icon-headset</div></li>
          <li><i class="layui-icon layui-icon-wenjianjiafan"></i><div class="name">文件夹（反）</div><div class="code">layui-icon-wenjianjiafan</div></li>
          <li><i class="layui-icon layui-icon-shouji"></i><div class="name">手机</div><div class="code">layui-icon-shouji</div></li>
          <li><i class="layui-icon layui-icon-tianjia2"></i><div class="name">添加2</div><div class="code">layui-icon-tianjia2</div></li>
          <li><i class="layui-icon layui-icon-wenjianjia"></i><div class="name">文件夹（反）</div><div class="code">layui-icon-wenjianjia</div></li>
          <li><i class="layui-icon layui-icon-biaoqing"></i><div class="name">表情</div><div class="code">layui-icon-biaoqing</div></li>
          <li><i class="layui-icon layui-icon-html"></i><div class="name">html</div><div class="code">layui-icon-html</div></li>
          <li><i class="layui-icon layui-icon-biaodan"></i><div class="name">表单</div><div class="code">layui-icon-biaodan</div></li>
          <li><i class="layui-icon layui-icon-cart"></i><div class="name">购物车</div><div class="code">layui-icon-cart</div></li>
          <li><i class="layui-icon layui-icon-camera-fill"></i><div class="name">相机-fill</div><div class="code">layui-icon-camera-fill</div></li>
          <li><i class="layui-icon layui-icon-25"></i><div class="name">&nbsp;</div><div class="code">layui-icon-25</div></li>
          <li><i class="layui-icon layui-icon-emwdaima"></i><div class="name">代码</div><div class="code">layui-icon-emwdaima</div></li>
          <li><i class="layui-icon layui-icon-fire"></i><div class="name">火</div><div class="code">layui-icon-fire</div></li>
          <li><i class="layui-icon layui-icon-set"></i><div class="name">设置</div><div class="code">layui-icon-set</div></li>
          <li><i class="layui-icon layui-icon-zitixiahuaxian"></i><div class="name">字体下划线</div><div class="code">layui-icon-zitixiahuaxian</div></li>
          <li><i class="layui-icon layui-icon-sanjiao1"></i><div class="name">三角1</div><div class="code">layui-icon-sanjiao1</div></li>
          <li><i class="layui-icon layui-icon-tips"></i><div class="name">提示</div><div class="code">layui-icon-tips</div></li>
          <li><i class="layui-icon layui-icon-tupian-copy-copy"></i><div class="name">图片</div><div class="code">layui-icon-tupian-copy-copy</div></li>
          <li><i class="layui-icon layui-icon-more-vertical"></i><div class="name">更多-竖</div><div class="code">layui-icon-more-vertical</div></li>
          <li><i class="layui-icon layui-icon-zhuti2"></i><div class="name">主题</div><div class="code">layui-icon-zhuti2</div></li>
          <li><i class="layui-icon layui-icon-loading"></i><div class="name">加载</div><div class="code">layui-icon-loading</div></li>
          <li><i class="layui-icon layui-icon-xieti"></i><div class="name">斜体</div><div class="code">layui-icon-xieti</div></li>
          <li><i class="layui-icon layui-icon-refresh-1"></i><div class="name">刷新-1</div><div class="code">layui-icon-refresh-1</div></li>
          <li><i class="layui-icon layui-icon-rmb"></i><div class="name">人民币</div><div class="code">layui-icon-rmb</div></li>
          <li><i class="layui-icon layui-icon-home"></i><div class="name">主页</div><div class="code">layui-icon-home</div></li>
          <li><i class="layui-icon layui-icon-user"></i><div class="name">用户</div><div class="code">layui-icon-user</div></li>
          <li><i class="layui-icon layui-icon-notice"></i><div class="name">注意</div><div class="code">layui-icon-notice</div></li>
          <li><i class="layui-icon layui-icon-login-weibo"></i><div class="name">新浪微博登录</div><div class="code">layui-icon-login-weibo</div></li>
          <li><i class="layui-icon layui-icon-voice"></i><div class="name">声音</div><div class="code">layui-icon-voice</div></li>
          <li><i class="layui-icon layui-icon-download"></i><div class="name">上传</div><div class="code">layui-icon-download</div></li>
          <li><i class="layui-icon layui-icon-login-qq"></i><div class="name">qq登录</div><div class="code">layui-icon-login-qq</div></li>
          <li><i class="layui-icon layui-icon-snowflake"></i><div class="name">雪花</div><div class="code">layui-icon-snowflake</div></li>
          <li><i class="layui-icon layui-icon-yemian1"></i><div class="name">页面</div><div class="code">layui-icon-yemian1</div></li>
          <li><i class="layui-icon layui-icon-template"></i><div class="name">模板</div><div class="code">layui-icon-template</div></li>
          <li><i class="layui-icon layui-icon-auz"></i><div class="name">护盾</div><div class="code">layui-icon-auz</div></li>
          <li><i class="layui-icon layui-icon-console"></i><div class="name">控制台</div><div class="code">layui-icon-console</div></li>
          <li><i class="layui-icon layui-icon-app"></i><div class="name">app</div><div class="code">layui-icon-app</div></li>
          <li><i class="layui-icon layui-icon-prev"></i><div class="name">前一个</div><div class="code">layui-icon-prev</div></li>
          <li><i class="layui-icon layui-icon-website"></i><div class="name">站点</div><div class="code">layui-icon-website</div></li>
          <li><i class="layui-icon layui-icon-next"></i><div class="name">后一个</div><div class="code">layui-icon-next</div></li>
          <li><i class="layui-icon layui-icon-component"></i><div class="name">部件</div><div class="code">layui-icon-component</div></li>
          <li><i class="layui-icon layui-icon-more"></i><div class="name">更多-横</div><div class="code">layui-icon-more</div></li>
          <li><i class="layui-icon layui-icon-login-wechat"></i><div class="name">微信登录</div><div class="code">layui-icon-login-wechat</div></li>
          <li><i class="layui-icon layui-icon-shrink-right"></i><div class="name">收缩</div><div class="code">layui-icon-shrink-right</div></li>
          <li><i class="layui-icon layui-icon-spread-left"></i><div class="name">展开</div><div class="code">layui-icon-spread-left</div></li>
          <li><i class="layui-icon layui-icon-camera"></i><div class="name">相机</div><div class="code">layui-icon-camera</div></li>
          <li><i class="layui-icon layui-icon-note"></i><div class="name">便笺</div><div class="code">layui-icon-note</div></li>
          <li><i class="layui-icon layui-icon-refresh"></i><div class="name">刷新</div><div class="code">layui-icon-refresh</div></li>
          <li><i class="layui-icon layui-icon-nv"></i><div class="name">女</div><div class="code">layui-icon-nv</div></li>
          <li><i class="layui-icon layui-icon-nan"></i><div class="name">男</div><div class="code">layui-icon-nan</div></li>
          <li><i class="layui-icon layui-icon-password"></i><div class="name">密码</div><div class="code">layui-icon-password</div></li>
          <li><i class="layui-icon layui-icon-senior"></i><div class="name">高级</div><div class="code">layui-icon-senior</div></li>
          <li><i class="layui-icon layui-icon-theme"></i><div class="name">样式</div><div class="code">layui-icon-theme</div></li>
          <li><i class="layui-icon layui-icon-tread"></i><div class="name">踩</div><div class="code">layui-icon-tread</div></li>
          <li><i class="layui-icon layui-icon-praise"></i><div class="name">顶</div><div class="code">layui-icon-praise</div></li>
          <li><i class="layui-icon layui-icon-star-fill"></i><div class="name">星星-fill</div><div class="code">layui-icon-star-fill</div></li>
          <li><i class="layui-icon layui-icon-template-1"></i><div class="name">模板1</div><div class="code">layui-icon-template-1</div></li>
          <li><i class="layui-icon layui-icon-loading-2"></i><div class="name">加载2</div><div class="code">layui-icon-loading-2</div></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="layui-fluid">
    <div class="layui-card">
      <div class="layui-card-body">
        <ul class="site-doc-icon">
          <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-a">
            开发图标
          </div>
          <li>
            <i class="layui-icon layui-icon-zserver">
            </i>
            <div class="code">
              layui-icon-zserver
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zserver-l">
            </i>
            <div class="code">
              layui-icon-zserver-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zservers">
            </i>
            <div class="code">
              layui-icon-zservers
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zhacker">
            </i>
            <div class="code">
              layui-icon-zhacker
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zkeyboard">
            </i>
            <div class="code">
              layui-icon-zkeyboard
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zkeyboard-l">
            </i>
            <div class="code">
              layui-icon-zkeyboard-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcommand">
            </i>
            <div class="code">
              layui-icon-zcommand
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcommand-l">
            </i>
            <div class="code">
              layui-icon-zcommand-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zusb">
            </i>
            <div class="code">
              layui-icon-zusb
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zusb-l">
            </i>
            <div class="code">
              layui-icon-zusb-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbug">
            </i>
            <div class="code">
              layui-icon-zbug
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbug-l">
            </i>
            <div class="code">
              layui-icon-zbug-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zsave-l">
            </i>
            <div class="code">
              layui-icon-zsave-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcode-file">
            </i>
            <div class="code">
              layui-icon-zcode-file
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcode-file-l">
            </i>
            <div class="code">
              layui-icon-zcode-file-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zfirewall">
            </i>
            <div class="code">
              layui-icon-zfirewall
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zfirewall-l">
            </i>
            <div class="code">
              layui-icon-zfirewall-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zmicrochip">
            </i>
            <div class="code">
              layui-icon-zmicrochip
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zmicrochip-l">
            </i>
            <div class="code">
              layui-icon-zmicrochip-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zprogram">
            </i>
            <div class="code">
              layui-icon-zprogram
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zconfiguration">
            </i>
            <div class="code">
              layui-icon-zconfiguration
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztab-select">
            </i>
            <div class="code">
              layui-icon-ztab-select
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zplatform">
            </i>
            <div class="code">
              layui-icon-zplatform
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztab">
            </i>
            <div class="code">
              layui-icon-ztab
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcontrol">
            </i>
            <div class="code">
              layui-icon-zcontrol
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcontrol-rank">
            </i>
            <div class="code">
              layui-icon-zcontrol-rank
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcode-plugin-l">
            </i>
            <div class="code">
              layui-icon-zcode-plugin-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcode-l">
            </i>
            <div class="code">
              layui-icon-zcode-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zoperation">
            </i>
            <div class="code">
              layui-icon-zoperation
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcode-edit-l">
            </i>
            <div class="code">
              layui-icon-zcode-edit-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zstorage-l">
            </i>
            <div class="code">
              layui-icon-zstorage-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcode-branch">
            </i>
            <div class="code">
              layui-icon-zcode-branch
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcode-fork">
            </i>
            <div class="code">
              layui-icon-zcode-fork
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zgreatwall">
            </i>
            <div class="code">
              layui-icon-zgreatwall
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztaiji">
            </i>
            <div class="code">
              layui-icon-ztaiji
            </div>
          ...
          <hr>
          <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-b">
            基地图标
          </div>

          <li>
            <i class="layui-icon layui-icon-zcircle-o">
            </i>
            <div class="code">
              layui-icon-zcircle-o
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcircle-l">
            </i>
            <div class="code">
              layui-icon-zcircle-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zsquare-o">
            </i>
            <div class="code">
              layui-icon-zsquare-o
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zsquare-l">
            </i>
            <div class="code">
              layui-icon-zsquare-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztriangle-o">
            </i>
            <div class="code">
              layui-icon-ztriangle-o
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztriangle-l">
            </i>
            <div class="code">
              layui-icon-ztriangle-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcamber-o">
            </i>
            <div class="code">
              layui-icon-zcamber-o
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcamber-l">
            </i>
            <div class="code">
              layui-icon-zcamber-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcup">
            </i>
            <div class="code">
              layui-icon-zcup
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcup-l">
            </i>
            <div class="code">
              layui-icon-zcup-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcalendar">
            </i>
            <div class="code">
              layui-icon-zcalendar
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcalendar-l">
            </i>
            <div class="code">
              layui-icon-zcalendar-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zhome">
            </i>
            <div class="code">
              layui-icon-zhome
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zhome-l">
            </i>
            <div class="code">
              layui-icon-zhome-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zimage">
            </i>
            <div class="code">
              layui-icon-zimage
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zimage-l">
            </i>
            <div class="code">
              layui-icon-zimage-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbuy">
            </i>
            <div class="code">
              layui-icon-zbuy
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbuy-l">
            </i>
            <div class="code">
              layui-icon-zbuy-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcomment">
            </i>
            <div class="code">
              layui-icon-zcomment
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcomment-l">
            </i>
            <div class="code">
              layui-icon-zcomment-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zchemistry">
            </i>
            <div class="code">
              layui-icon-zchemistry
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zchemistry-l">
            </i>
            <div class="code">
              layui-icon-zchemistry-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbookmark">
            </i>
            <div class="code">
              layui-icon-zbookmark
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbookmark-l">
            </i>
            <div class="code">
              layui-icon-zbookmark-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbook">
            </i>
            <div class="code">
              layui-icon-zbook
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbook-l">
            </i>
            <div class="code">
              layui-icon-zbook-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbuilding">
            </i>
            <div class="code">
              layui-icon-zbuilding
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbuilding-l">
            </i>
            <div class="code">
              layui-icon-zbuilding-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zgame">
            </i>
            <div class="code">
              layui-icon-zgame
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zgame-l">
            </i>
            <div class="code">
              layui-icon-zgame-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zheadset">
            </i>
            <div class="code">
              layui-icon-zheadset
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zheadset-l">
            </i>
            <div class="code">
              layui-icon-zheadset-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zgift">
            </i>
            <div class="code">
              layui-icon-zgift
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zgift-l">
            </i>
            <div class="code">
              layui-icon-zgift-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zheart">
            </i>
            <div class="code">
              layui-icon-zheart
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zheart-l">
            </i>
            <div class="code">
              layui-icon-zheart-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zprinter">
            </i>
            <div class="code">
              layui-icon-zprinter
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zprinter-l">
            </i>
            <div class="code">
              layui-icon-zprinter-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zinbox">
            </i>
            <div class="code">
              layui-icon-zinbox
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zinbox-l">
            </i>
            <div class="code">
              layui-icon-zinbox-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zright-clipboard">
            </i>
            <div class="code">
              layui-icon-zright-clipboard
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zright-clipboard-l">
            </i>
            <div class="code">
              layui-icon-zright-clipboard-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlist-clipboard">
            </i>
            <div class="code">
              layui-icon-zlist-clipboard
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlist-clipboard-l">
            </i>
            <div class="code">
              layui-icon-zlist-clipboard-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztalk">
            </i>
            <div class="code">
              layui-icon-ztalk
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-ztalk-l">
            </i>
            <div class="code">
              layui-icon-ztalk-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-ztime">
            </i>
            <div class="code">
              layui-icon-ztime
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-ztime-l">
            </i>
            <div class="code">
              layui-icon-ztime-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbar-chart">
            </i>
            <div class="code">
              layui-icon-zbar-chart
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbar-chart-l">
            </i>
            <div class="code">
              layui-icon-zbar-chart-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlock">
            </i>
            <div class="code">
              layui-icon-zlock
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zlock-l">
            </i>
            <div class="code">
              layui-icon-zlock-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmusic">
            </i>
            <div class="code">
              layui-icon-zmusic
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmusic-l">
            </i>
            <div class="code">
              layui-icon-zmusic-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmusic-note">
            </i>
            <div class="code">
              layui-icon-zmusic-note
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zmusic-note-l">
            </i>
            <div class="code">
              layui-icon-zmusic-note-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zfilm">
            </i>
            <div class="code">
              layui-icon-zfilm
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zfilm-l">
            </i>
            <div class="code">
              layui-icon-zfilm-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zlight">
            </i>
            <div class="code">
              layui-icon-zlight
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zlight-l">
            </i>
            <div class="code">
              layui-icon-zlight-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmedal">
            </i>
            <div class="code">
              layui-icon-zmedal
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmedal-l">
            </i>
            <div class="code">
              layui-icon-zmedal-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmouse">
            </i>
            <div class="code">
              layui-icon-zmouse
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmouse-l">
            </i>
            <div class="code">
              layui-icon-zmouse-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmicrophone">
            </i>
            <div class="code">
              layui-icon-zmicrophone
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zmicrophone-l">
            </i>
            <div class="code">
              layui-icon-zmicrophone-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zvolume">
            </i>
            <div class="code">
              layui-icon-zvolume
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zvolume-l">
            </i>
            <div class="code">
              layui-icon-zvolume-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zwatch">
            </i>
            <div class="code">
              layui-icon-zwatch
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zwatch-l">
            </i>
            <div class="code">
              layui-icon-zwatch-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-ztag">
            </i>
            <div class="code">
              layui-icon-ztag
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-ztag-l">
            </i>
            <div class="code">
              layui-icon-ztag-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zwebcam">
            </i>
            <div class="code">
              layui-icon-zwebcam
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zwebcam-l">
            </i>
            <div class="code">
              layui-icon-zwebcam-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zsetting">
            </i>
            <div class="code">
              layui-icon-zsetting
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zsetting-l">
            </i>
            <div class="code">
              layui-icon-zsetting-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zstar">
            </i>
            <div class="code">
              layui-icon-zstar
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zstar-l">
            </i>
            <div class="code">
              layui-icon-zstar-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbell">
            </i>
            <div class="code">
              layui-icon-zbell
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbell-l">
            </i>
            <div class="code">
              layui-icon-zbell-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcloud">
            </i>
            <div class="code">
              layui-icon-zcloud
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcloud-l">
            </i>
            <div class="code">
              layui-icon-zcloud-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbattery">
            </i>
            <div class="code">
              layui-icon-zbattery
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbattery-l">
            </i>
            <div class="code">
              layui-icon-zbattery-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zairplane">
            </i>
            <div class="code">
              layui-icon-zairplane
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zairplane-l">
            </i>
            <div class="code">
              layui-icon-zairplane-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztrash">
            </i>
            <div class="code">
              layui-icon-ztrash
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-ztrash-l">
            </i>
            <div class="code">
              layui-icon-ztrash-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zfile">
            </i>
            <div class="code">
              layui-icon-zfile
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zfile-l">
            </i>
            <div class="code">
              layui-icon-zfile-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zdoc-file">
            </i>
            <div class="code">
              layui-icon-zdoc-file
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zdoc-file-l">
            </i>
            <div class="code">
              layui-icon-zdoc-file-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcomputer">
            </i>
            <div class="code">
              layui-icon-zcomputer
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcomputer-l">
            </i>
            <div class="code">
              layui-icon-zcomputer-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlaptop">
            </i>
            <div class="code">
              layui-icon-zlaptop
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zlaptop-l">
            </i>
            <div class="code">
              layui-icon-zlaptop-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zmobile">
            </i>
            <div class="code">
              layui-icon-zmobile
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmobile-l">
            </i>
            <div class="code">
              layui-icon-zmobile-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zuser">
            </i>
            <div class="code">
              layui-icon-zuser
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zuser-l">
            </i>
            <div class="code">
              layui-icon-zuser-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmessage">
            </i>
            <div class="code">
              layui-icon-zmessage
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmessage-l">
            </i>
            <div class="code">
              layui-icon-zmessage-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcamera">
            </i>
            <div class="code">
              layui-icon-zcamera
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcamera-l">
            </i>
            <div class="code">
              layui-icon-zcamera-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlocation">
            </i>
            <div class="code">
              layui-icon-zlocation
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlocation-l">
            </i>
            <div class="code">
              layui-icon-zlocation-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zread">
            </i>
            <div class="code">
              layui-icon-zread
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zread-l">
            </i>
            <div class="code">
              layui-icon-zread-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zclock">
            </i>
            <div class="code">
              layui-icon-zclock
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zclock-l">
            </i>
            <div class="code">
              layui-icon-zclock-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbluetooth">
            </i>
            <div class="code">
              layui-icon-zbluetooth
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbluetooth-l">
            </i>
            <div class="code">
              layui-icon-zbluetooth-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcalculator">
            </i>
            <div class="code">
              layui-icon-zcalculator
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcalculator-l">
            </i>
            <div class="code">
              layui-icon-zcalculator-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcoin">
            </i>
            <div class="code">
              layui-icon-zcoin
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcoin-l">
            </i>
            <div class="code">
              layui-icon-zcoin-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbriefcase">
            </i>
            <div class="code">
              layui-icon-zbriefcase
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbriefcase-l">
            </i>
            <div class="code">
              layui-icon-zbriefcase-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zeye">
            </i>
            <div class="code">
              layui-icon-zeye
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zeye-l">
            </i>
            <div class="code">
              layui-icon-zeye-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zruler">
            </i>
            <div class="code">
              layui-icon-zruler
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zruler-l">
            </i>
            <div class="code">
              layui-icon-zruler-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zclothes">
            </i>
            <div class="code">
              layui-icon-zclothes
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zclothes-l">
            </i>
            <div class="code">
              layui-icon-zclothes-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zbrush">
            </i>
            <div class="code">
              layui-icon-zbrush
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zbrush-l">
            </i>
            <div class="code">
              layui-icon-zbrush-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zrollerbrush">
            </i>
            <div class="code">
              layui-icon-zrollerbrush
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zrollerbrush-l">
            </i>
            <div class="code">
              layui-icon-zrollerbrush-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcrown">
            </i>
            <div class="code">
              layui-icon-zcrown
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcrown-l">
            </i>
            <div class="code">
              layui-icon-zcrown-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zboard">
            </i>
            <div class="code">
              layui-icon-zboard
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zboard-l">
            </i>
            <div class="code">
              layui-icon-zboard-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmap">
            </i>
            <div class="code">
              layui-icon-zmap
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zmap-l">
            </i>
            <div class="code">
              layui-icon-zmap-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zlightning">
            </i>
            <div class="code">
              layui-icon-zlightning
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlightning-l">
            </i>
            <div class="code">
              layui-icon-zlightning-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztruck">
            </i>
            <div class="code">
              layui-icon-ztruck
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-ztruck-l">
            </i>
            <div class="code">
              layui-icon-ztruck-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zshopping-cart">
            </i>
            <div class="code">
              layui-icon-zshopping-cart
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zshopping-cart-l">
            </i>
            <div class="code">
              layui-icon-zshopping-cart-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zrocket">
            </i>
            <div class="code">
              layui-icon-zrocket
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zrocket-l">
            </i>
            <div class="code">
              layui-icon-zrocket-l
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-ztriangle">
            </i>
            <div class="code">
              layui-icon-ztriangle
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zsquare">
            </i>
            <div class="code">
              layui-icon-zsquare
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcircle">
            </i>
            <div class="code">
              layui-icon-zcircle
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zcamber">
            </i>
            <div class="code">
              layui-icon-zcamber
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zx-buy-l">
            </i>
            <div class="code">
              layui-icon-zx-buy-l
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zpaper-plane">
            </i>
            <div class="code">
              layui-icon-zpaper-plane
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zquote-left">
            </i>
            <div class="code">
              layui-icon-zquote-left
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zquote-right">
            </i>
            <div class="code">
              layui-icon-zquote-right
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zd-space">
            </i>
            <div class="code">
              layui-icon-zd-space
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zthumbs-up">
            </i>
            <div class="code">
              layui-icon-zthumbs-up
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zwifi">
            </i>
            <div class="code">
              layui-icon-zwifi
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zpixels">
            </i>
            <div class="code">
              layui-icon-zpixels
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zprototype">
            </i>
            <div class="code">
              layui-icon-zprototype
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zvector-design">
            </i>
            <div class="code">
              layui-icon-zvector-design
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zconnection">
            </i>
            <div class="code">
              layui-icon-zconnection
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zforum">
            </i>
            <div class="code">
              layui-icon-zforum
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zuser-framework">
            </i>
            <div class="code">
              layui-icon-zuser-framework
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zanalysis">
            </i>
            <div class="code">
              layui-icon-zanalysis
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zcollection">
            </i>
            <div class="code">
              layui-icon-zcollection
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zdata-test">
            </i>
            <div class="code">
              layui-icon-zdata-test
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zweb-edit">
            </i>
            <div class="code">
              layui-icon-zweb-edit
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zfont">
            </i>
            <div class="code">
              layui-icon-zfont
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zoverlapping">
            </i>
            <div class="code">
              layui-icon-zoverlapping
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zpad">
            </i>
            <div class="code">
              layui-icon-zpad
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zlayers">
            </i>
            <div class="code">
              layui-icon-zlayers
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zlayout-grid">
            </i>
            <div class="code">
              layui-icon-zlayout-grid
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlayout-grids">
            </i>
            <div class="code">
              layui-icon-zlayout-grids
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zlayout-list">
            </i>
            <div class="code">
              layui-icon-zlayout-list
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zpaper">
            </i>
            <div class="code">
              layui-icon-zpaper
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zpeople">
            </i>
            <div class="code">
              layui-icon-zpeople
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zpokemon-ball">
            </i>
            <div class="code">
              layui-icon-zpokemon-ball
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zred-envelope">
            </i>
            <div class="code">
              layui-icon-zred-envelope
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zmoney">
            </i>
            <div class="code">
              layui-icon-zmoney
            </div>
          ...
          <li>
            <i class="layui-icon layui-icon-zd-glasses">
            </i>
            <div class="code">
              layui-icon-zd-glasses
            </div>
          </li>
          <li>
            <i class="layui-icon layui-icon-zadd">
            </i>
            <div class="code">
              layui-icon-zadd
            </div>
          ...
          <li>
            ...
            <hr>
            <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-c">
              线性图标
            </div>
            <li>
              <i class="layui-icon layui-icon-zpen">
              </i>
              <div class="code">
                layui-icon-zpen
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zpen-write">
              </i>
              <div class="code">
                layui-icon-zpen-write
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zcome-l">
              </i>
              <div class="code">
                layui-icon-zcome-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zout-l">
              </i>
              <div class="code">
                layui-icon-zout-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zqrcode-l">
              </i>
              <div class="code">
                layui-icon-zqrcode-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zscan-l">
              </i>
              <div class="code">
                layui-icon-zscan-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zvolume-x-l">
              </i>
              <div class="code">
                layui-icon-zvolume-x-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zinfo-l">
              </i>
              <div class="code">
                layui-icon-zinfo-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zscissors">
              </i>
              <div class="code">
                layui-icon-zscissors
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zlink-l">
              </i>
              <div class="code">
                layui-icon-zlink-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zchoose-list-l">
              </i>
              <div class="code">
                layui-icon-zchoose-list-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zwrite-l">
              </i>
              <div class="code">
                layui-icon-zwrite-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zblackboard-l">
              </i>
              <div class="code">
                layui-icon-zblackboard-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zthumbs-up-l">
              </i>
              <div class="code">
                layui-icon-zthumbs-up-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-ztransmission-l">
              </i>
              <div class="code">
                layui-icon-ztransmission-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zwrench-l">
              </i>
              <div class="code">
                layui-icon-zwrench-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-ztime-plugin-l">
              </i>
              <div class="code">
                layui-icon-ztime-plugin-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zlabel-info-l">
              </i>
              <div class="code">
                layui-icon-zlabel-info-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zsword-l">
              </i>
              <div class="code">
                layui-icon-zsword-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zproduct-l">
              </i>
              <div class="code">
                layui-icon-zproduct-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zdoc-edit">
              </i>
              <div class="code">
                layui-icon-zdoc-edit
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-znew-l">
              </i>
              <div class="code">
                layui-icon-znew-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-znewspaper-l">
              </i>
              <div class="code">
                layui-icon-znewspaper-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zprototype-select-l">
              </i>
              <div class="code">
                layui-icon-zprototype-select-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zconstruct-l">
              </i>
              <div class="code">
                layui-icon-zconstruct-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zcontainer-l">
              </i>
              <div class="code">
                layui-icon-zcontainer-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zdetect-l">
              </i>
              <div class="code">
                layui-icon-zdetect-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zgit-l">
              </i>
              <div class="code">
                layui-icon-zgit-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zprogram-framework-l">
              </i>
              <div class="code">
                layui-icon-zprogram-framework-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zaso-l">
              </i>
              <div class="code">
                layui-icon-zaso-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-znetwork-l">
              </i>
              <div class="code">
                layui-icon-znetwork-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zsite-folder-l">
              </i>
              <div class="code">
                layui-icon-zsite-folder-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zassociation-l">
              </i>
              <div class="code">
                layui-icon-zassociation-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zcertificate">
              </i>
              <div class="code">
            ...
            <li>
              <i class="layui-icon layui-icon-zdesign-edit-l">
              </i>
              <div class="code">
                layui-icon-zdesign-edit-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zdesign-shape-l">
              </i>
              <div class="code">
                layui-icon-zdesign-shape-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zfire-l">
              </i>
              <div class="code">
                layui-icon-zfire-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zfolder-l">
              </i>
              <div class="code">
                layui-icon-zfolder-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zgeometry-shape-l">
              </i>
              <div class="code">
                layui-icon-zgeometry-shape-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zlight-flash-l">
              </i>
              <div class="code">
                layui-icon-zlight-flash-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zbook-l">
            ...
            <li>
              <i class="layui-icon layui-icon-zclip-l">
              </i>
              <div class="code">
                layui-icon-zclip-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zclose-l">
              </i>
              <div class="code">
                layui-icon-zclose-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zdiamond-l">
              </i>
              <div class="code">
                layui-icon-zdiamond-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zdownload-l">
              </i>
              <div class="code">
                layui-icon-zdownload-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zeye-l">
            ...
            <li>
              <i class="layui-icon layui-icon-zmenu-l">
              </i>
              <div class="code">
                layui-icon-zmenu-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zcategory-l">
              </i>
              <div class="code">
                layui-icon-zcategory-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zmessage-l">
            ...
            <li>
              <i class="layui-icon layui-icon-zsearch-l">
              </i>
              <div class="code">
                layui-icon-zsearch-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zsetting-l">
            ...
            <li>
              <i class="layui-icon layui-icon-zshield-l">
              </i>
              <div class="code">
                layui-icon-zshield-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-ztag-l">
            ...
            <li>
              <i class="layui-icon layui-icon-zupload-l">
              </i>
              <div class="code">
                layui-icon-zupload-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zworld-l">
              </i>
              <div class="code">
                layui-icon-zworld-l
              </div>
            ...
            <hr>
            <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-d">
              多媒体图标
            </div>
            <li>
              <i class="layui-icon layui-icon-zheadset">
            ...
            <li>
              <i class="layui-icon layui-icon-zvideo-file">
              </i>
              <div class="code">
            ...
            <li>
              <i class="layui-icon layui-icon-zvideo-file-l">
              </i>
              <div class="code">
                layui-icon-zvideo-file-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zmusic-file">
              </i>
              <div class="code">
                layui-icon-zmusic-file
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zmusic-file-l">
              </i>
              <div class="code">
                layui-icon-zmusic-file-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zslider-l">
              </i>
              <div class="code">
                layui-icon-zslider-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zplay-l">
              </i>
              <div class="code">
                layui-icon-zplay-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zpause-l">
              </i>
              <div class="code">
                layui-icon-zpause-l
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zvideo-camera-l">
              </i>
              <div class="code">
                layui-icon-zvideo-camera-l
              </div>
            </li>
            <hr>
            <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-e">
              箭头的方向
            </div>
            <li>
              <i class="layui-icon layui-icon-zangle-down-l">
              </i>
              <div class="code">
                layui-icon-zangle-down-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zangle-left-l">
              </i>
              <div class="code">
                layui-icon-zangle-left-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zangle-right-l">
              </i>
              <div class="code">
                layui-icon-zangle-right-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zangle-up-l">
              </i>
              <div class="code">
                layui-icon-zangle-up-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zarrow-down-l">
              </i>
              <div class="code">
                layui-icon-zarrow-down-l
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zarrow-up-l">
              </i>
              <div class="code">
                layui-icon-zarrow-up-l
              </div>
            </li>
            <hr>
            <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-f">
              手势操作
            </div>
            <li>
              <i class="layui-icon layui-icon-zhand-bevel">
              </i>
              <div class="code">
                layui-icon-zhand-bevel
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-slide">
              </i>
              <div class="code">
                layui-icon-zhand-slide
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-gather">
              </i>
              <div class="code">
                layui-icon-zhand-gather
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhande-vertical">
              </i>
              <div class="code">
                layui-icon-zhande-vertical
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-horizontal">
              </i>
              <div class="code">
                layui-icon-zhand-horizontal
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-button">
              </i>
              <div class="code">
                layui-icon-zhand-button
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-touch">
              </i>
              <div class="code">
                layui-icon-zhand-touch
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-pointer">
              </i>
              <div class="code">
                layui-icon-zhand-pointer
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-grasp">
              </i>
              <div class="code">
                layui-icon-zhand-grasp
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhand-stop">
              </i>
              <div class="code">
                layui-icon-zhand-stop
              </div>
            </li>
            <hr>
            <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-g">
              国际品牌
            </div>
            <li>
              <i class="layui-icon layui-icon-zandroid">
              </i>
              <div class="code">
                layui-icon-zandroid
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zapple">
              </i>
              <div class="code">
                layui-icon-zapple
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zchrome">
              </i>
              <div class="code">
                layui-icon-zchrome
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zcss3">
              </i>
              <div class="code">
                layui-icon-zcss3
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zdribbble">
              </i>
              <div class="code">
                layui-icon-zdribbble
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zdropbox">
              </i>
              <div class="code">
                layui-icon-zdropbox
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zfacebook">
              </i>
              <div class="code">
                layui-icon-zfacebook
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zhtml5">
              </i>
              <div class="code">
                layui-icon-zhtml5
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zlinux">
              </i>
              <div class="code">
                layui-icon-zlinux
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zmicrosoft">
              </i>
              <div class="code">
                layui-icon-zmicrosoft
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zrss">
              </i>
              <div class="code">
                layui-icon-zrss
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zsteam">
              </i>
              <div class="code">
                layui-icon-zsteam
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-ztwitter">
              </i>
              <div class="code">
                layui-icon-ztwitter
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zvimeo">
              </i>
              <div class="code">
                layui-icon-zvimeo
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zwordpress">
              </i>
              <div class="code">
                layui-icon-zwordpress
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zyoutube">
              </i>
              <div class="code">
                layui-icon-zyoutube
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zgithub">
              </i>
              <div class="code">
                layui-icon-zgithub
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zgithub-logo">
              </i>
              <div class="code">
                layui-icon-zgithub-logo
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zInstagram">
              </i>
              <div class="code">
                layui-icon-zInstagram
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zpaypal">
              </i>
              <div class="code">
                layui-icon-zpaypal
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zpinterest">
              </i>
              <div class="code">
                layui-icon-zpinterest
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-ztelegram">
              </i>
              <div class="code">
                layui-icon-ztelegram
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zraspberry">
              </i>
              <div class="code">
                layui-icon-zraspberry
              </div>
            </li>
            <hr>
            <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-h">
              中国品牌
            </div>
            <li>
              <i class="layui-icon layui-icon-zweixin">
              </i>
              <div class="code">
                layui-icon-zweixin
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zqq">
              </i>
              <div class="code">
                layui-icon-zqq
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zmoments">
              </i>
              <div class="code">
                layui-icon-zmoments
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-ztaobao">
              </i>
              <div class="code">
                layui-icon-ztaobao
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-ztmall">
              </i>
              <div class="code">
                layui-icon-ztmall
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zweibo">
              </i>
              <div class="code">
                layui-icon-zweibo
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zweixinzhifu">
              </i>
              <div class="code">
                layui-icon-zweixinzhifu
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zalipay">
              </i>
              <div class="code">
                layui-icon-zalipay
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zbitcoin">
              </i>
              <div class="code">
                layui-icon-zbitcoin
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zbaiduwangpan">
              </i>
              <div class="code">
                layui-icon-zbaiduwangpan
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zcaomei">
              </i>
              <div class="code">
                layui-icon-zcaomei
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zv2ex">
              </i>
              <div class="code">
                layui-icon-zv2ex
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zbilibili">
              </i>
              <div class="code">
                layui-icon-zbilibili
              </div>
            </li>
            <li>
              <i class="layui-icon layui-icon-zqzone">
              </i>
              <div class="code">
                layui-icon-zqzone
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zzhihu">
              </i>
              <div class="code">
                layui-icon-zzhihu
              </div>
            ...
            <li>
              <i class="layui-icon layui-icon-zchuangzaoshi">
              </i>
              <div class="code">
                layui-icon-zchuangzaoshi
              </div>
            </li>
  ...
  <div class="layui-card-header" style="text-align: center;">
    layui的图标库来自群里，我把群里两个大佬(luoye、月磊)的文件，整合一起了，优化了下宫格的宽度，可以完整显示字体class。
  </div>

  <div class="layui-card-header" style="text-align: center;">
    整合了第三方的ICO图标库，充分完善Laui的ico图标库，右边是锚点，可快速定位到相应的地方，方便快速查找。
  </div>

  <div class="layui-card-header" style="text-align: center;">
    整合人：仔仔235  感谢luoye和月磊的相关layui文件。
  </div>
